...
export default function Navbar() {
  return (
    <>
      <div className="fixed top-0 left-0 z-50 w-full flex justify-between items-center gap-2 p-3 backdrop-blur-lg bg-white/40 dark:bg-slate-700/60 border-b border-white/20 shadow-[0_8px_30px_rgba(0,0,0,0.08)] supports-[backdrop-filter]:bg-white/50 " >
        <div className=""> 
