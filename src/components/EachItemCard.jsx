...
import EachProdDetails from './Buttons/EachProdDetails'

export default function EachItemCard({ eachItem }) {
  return (
    <div className="bg-gray-50 border border-red-800 w-[300px] m-3 p-4 rounded-2xl shadow transition-transform duration-300 hover:bg-red-100 hover:scale-105 hover:shadow-2xl">
     ...
     <EachProdDetails id={eachItem?.id} key={eachItem.id}/>
